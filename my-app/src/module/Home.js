...
let HomeScreen = require('../Images/home_Screen.png')
//my Image does not work idk why, i tried the import version too
function Home() {
  return (
    <div id='root' className="App">
      ...
      <image src={HomeScreen} style={{width:'81px', height: '61px', margin: '10px'}}/>
    </div>
  );
}
